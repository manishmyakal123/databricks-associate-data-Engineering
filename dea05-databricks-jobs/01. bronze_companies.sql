...
CREATE SCHEMA IF NOT EXISTS demo.bronze
     MANAGED LOCATION 'abfss://demo@deacourseextdlgizmobox.dfs.core.windows.net/bronze';  
...
SELECT company_name, founded_date, country
  FROM read_files('abfss://demo@deacourseextdlgizmobox.dfs.core.windows.net/landing/companies',
                  format => 'csv',
                  header => true);