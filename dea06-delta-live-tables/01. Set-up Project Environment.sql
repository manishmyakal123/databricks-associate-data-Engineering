...
CREATE EXTERNAL LOCATION IF NOT EXISTS dea_course_ext_dl_circuitbox
  URL 'abfss://circuitbox@deacourseextdlgizmobox.dfs.core.windows.net/'
  WITH (STORAGE CREDENTIAL dea_course_adls)
  COMMENT 'External Location for the circuitbox data lakehouse';

-- COMMAND ----------

-- MAGIC %fs ls 'abfss://circuitbox@deacourseextdlgizmobox.dfs.core.windows.net/'
...
CREATE CATALOG IF NOT EXISTS circuitbox
  MANAGED LOCATION 'abfss://circuitbox@deacourseextdlgizmobox.dfs.core.windows.net/'
...
CREATE SCHEMA IF NOT EXISTS landing
   MANAGED LOCATION 'abfss://circuitbox@deacourseextdlgizmobox.dfs.core.windows.net/landing';

CREATE SCHEMA IF NOT EXISTS lakehouse
   MANAGED LOCATION 'abfss://circuitbox@deacourseextdlgizmobox.dfs.core.windows.net/lakehouse';
...
CREATE EXTERNAL VOLUME IF NOT EXISTS operational_data
      LOCATION 'abfss://circuitbox@deacourseextdlgizmobox.dfs.core.windows.net/landing/operational_data';
